...
public class GenderSection {
    ...
    private final By femaleRadioButton = new By.ByCssSelector("label[for='gender-radio-1']");
    private final By otherRadioButton = new By.ByCssSelector("label[for='gender-radio-1']");
